...
<h3 id="likes">Likes <span style="color:rgba(0,0,0,0.6);font-style: italic;">(Atleast 5)</span>
    ...
    <input type="text" placeholder="add what you like" v-model="add" v-on:keyup.enter="addLike" ref="input" @click="goto('input')">
    </div>
    </div>
</template>
